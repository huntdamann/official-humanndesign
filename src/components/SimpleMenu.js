...
export default function SimpleMenu() {
  ...
  const threeOptions = [
    "Product Development",
    "3D Web Design",
    "3D Virtual Experiences/Tours (Starting Soon)",
  ];
  ...
  return (
    <section className="w-full  h-3/4 flex flex-col items-center justify-center">
      <ul className="flex flex-col w-[90%] lg:w-2/4 gap-5 mt-5">
        ...
        <motion.li
          animate={{
            x: brandPlus || leadPlus || threePlus ? 200 : 0,
            opacity: brandPlus || leadPlus || threePlus ? 0 : 1,
          }}
        ...
        {/* <motion.li
          animate={{
            x: webPlus || leadPlus || threePlus ? 200 : 0,
            opacity: webPlus || leadPlus || threePlus ? 0 : 1,
          }}
          className="w-full relative"
        >
          <motion.div
        ...
        <motion.li
          animate={{
            x: webPlus || brandPlus || leadPlus ? 200 : 0,
            opacity: webPlus || brandPlus || leadPlus ? 0 : 1,
          }}
          className="w-full relative"
        >
          <motion.div
        ...
        <motion.li
          animate={{
            x: threePlus || webPlus || brandPlus || leadPlus ? 200 : 0,
            opacity: webPlus || brandPlus || threePlus || leadPlus ? 0 : 1,
          }}
          className="w-full relative"
        >
          <motion.div
