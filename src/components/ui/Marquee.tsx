...
interface StockItem {
  ...
  const stocks: StockItem[] = [
    ...
    { company: "Mobile App Development", price: "199.40", change: "+7.43 (+3.87%)", direction: "plus" },
    { company: "Product Design", price: "199.40", change: "+7.43 (+3.87%)", direction: "plus" },
    { company: "Web Design", price: "587.65", change: "+4.09 (+0.70%)", direction: "plus" },
    { company: "Graphic Design", price: "138.75", change: "-6.54 (-4.50%)", direction: "minus" },
