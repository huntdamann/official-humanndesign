    ...
    <motion.footer id="footer-container" initial={{y: 40, opacity: 0}} whileInView={{y:0, opacity: 1}} viewport={{amount: 0.2, once: true }} className="w-full bg-black text-white px-6 py-12 lg:py-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-12">
        ...
        <div className="footer-left">
          ...
          <ul className="space-y-3 flex flex-col gap-3 text-sm uppercase text-gray-300">
        ...
        <div className="footer-right special-right">
          <h3 className="text-lg font-semibold mb-6 text-[#72d0c8] uppercase tracking-wide">
            Let&apos;s Connect
          </h3>
          <p className="text-sm text-gray-300 mb-6 w-[350px] leading-relaxed">
            I would love to hear from you! Click on the button below to schedule a call to discuss the possibilities of us creating something together.
          </p>
            <GenericButton text="Schedule A Call" link="https://calendly.com/hunter-mann2433/30min" />

        </div>
      </div>

      {/* Divider + Footer bottom */}
      <div style={{marginTop: "48px"}} className="max-w-7xl mx-auto border-t border-gray-700 mt-12 pt-6 flex flex-col sm:flex-row justify-between text-xs text-gray-500">
